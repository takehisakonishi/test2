...
namespace BTWrapper
{
    ...
    public class SelectedArea
    {
        ...
        public bool CheckAreaInGraph(Chart a)
        {
        ...
        public void SetChartDrawArea(Axis AxisX, Axis AxisY)
        {
        ...
        public void SetAxisLimits(Axis AxisX, Axis AxisY)
        {
        ...
        public void SetChartDrawAreaLimitedY(Axis AxisX, Axis AxisY, double[] x, params object[] ys)
        {
            double ymax = -1;
            AxisX.Minimum = AxisX.PixelPositionToValue(x0);
            AxisX.Maximum = AxisX.PixelPositionToValue(x1);
        ...
        public void SetChartDrawAreaLimitedY(Axis AxisX, Axis AxisY, double ymax)
        {
            AxisX.Minimum = AxisX.PixelPositionToValue(x0);
            AxisX.Maximum = AxisX.PixelPositionToValue(x1);
            AxisY.Minimum = -ymax;
